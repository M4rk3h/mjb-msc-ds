...
![Date Picker - Stats Wales](img/date-picker.png "Date Picker")
...
plot.one + 
  labs(title = "Number of GPs employed in general practices", 
       subtitle = "by GP type and local health board (30-September-2020)") +
...
write.csv(df.no.wales)
# write.csv(df.no.wales, file = "data/gps-employed.csv")
```
