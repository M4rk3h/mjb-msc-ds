---
title: "Lexicon example - US Presidents"
...
```{r}
files <- list.files("C:/Users/pholborn/Dropbox/MS4S09/Presidents")
files
```

```{r}
# stick together the path to the file & 1st file name
fileName <- glue("C:/Users/pholborn/Dropbox/MS4S09/Presidents/", files[1],.sep="")
...
```{r}
# write a function that takes the name of a file and returns the no. of postive sentiment words, negative sentiment words, the difference & the normalised difference
GetSentiment <- function(file){

    # get the file
    fileName <- glue("C:/Users/pholborn/Dropbox/MS4S09/Presidents/", file, sep = "")
    # get rid of any sneaky trailing spaces
    fileName <- trimws(fileName)
